...
export const DynamicLoadedChatlio = dynamic(
  import('./chatlio')
    .then(comp => comp)
    .catch(err => {
      return (
        <DynamicLoadedNote>Chatlio module is not loaded.</DynamicLoadedNote>
      )
    }),
  {
    loading: function Loading() {
...
export const DynamicLoadedCrisp = dynamic(
  import('./crisp')
    .then(comp => comp)
    .catch(err => {
      return <DynamicLoadedNote>Crisp module is not loaded.</DynamicLoadedNote>
    }),
  {
    loading: function Loading() {
      return <span />
...
const useTalkToUs = appName => {
  ...
  const comp = appName => {
    ...
    } else if (appName === 'chatlio') {
      return useLazyComps('chatlio', <DynamicLoadedChatlio />)
    } else if (appName === 'crisp') {
      return useLazyComps('crisp', <DynamicLoadedCrisp />)
    }
  }
